            ...
            <form class="form-inline md-form form-sm mt-2 ml-4" method="POST" action="search.php">
                <div class="row">
                    ...
                    <div class="col-8 px-0">
                        <input name="search" class="form-control form-control-sm " type="text" style="font-style:italic" placeholder="Search for a recipe!" aria-label="Search" required="required">
                    </div>
